...
You can get its data structure with `i14y_get_dataset_structure()`. The
new public API returns the structure as a SHACL/RDF graph in JSON-LD,
Turtle or RDF/XML — pick a format with the `format` argument:
