...
with the value from the `id` column.
...
[`i14y_search_catalog()`](https://felixluginbuhl.com/I14Y/reference/i14y_search_catalog.md)
shows if the content is a “Dataset”, a “DataService” or a
“PublicService”.
...
#> 'data.frame':    18 obs. of  33 variables:
...
`NOGA_GROUP`, `NOGA_CLASS`). Use
[`i14y_search_concept()`](https://felixluginbuhl.com/I14Y/reference/i14y_search_concept.md)
to find the relevant concept and then
[`i14y_get_codelist()`](https://felixluginbuhl.com/I14Y/reference/i14y_get_codelist.md)
to download the codes for that level.
...
The new public API returns the structure as a SHACL/RDF graph in
JSON-LD, Turtle or RDF/XML — pick a format with the `format` argument:
